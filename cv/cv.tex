...
\begin{center}
    ...
    {\includegraphics[height=1.2em]{Telegram.png}}\href{https://t.me/mapll6}{  Mahdi} 
    }
\end{center}
\vspace{-6mm}
\begin{center}
...
\vspace{1mm}
\small{
Highly motivated  Frontend Developer with over two years of experience in creating responsive, user-friendly web apps. My programming journey began as a hobby in 2016, and I started specializing in JavaScript in 2022. Since then, I’ve contributed to projects for Semnan University, an accounting firm, and other company websites. Currently, I work with Bluprint, a contracting company, where I’ve gained valuable experience building diverse projects and delivering quality solutions.
...
\vspace{-0.4mm}
  ...
  \resumeSubheading
      ...
      {Frontend Developer}{March 2024 - now}
      \resumeItemListStart
      \vspace{6mm}
During my time at this company, I faced challenges like learning \textbf{React Native}, \textbf{Redux}, and \textbf{Zustand}, and successfully completed \textbf{five projects}, with three currently active. I also worked in teams on two projects. Key projects include:
      \resumeItemListEnd 
      \vspace{2mm}
